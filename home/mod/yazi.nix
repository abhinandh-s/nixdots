  ...
  programs.yazi = {
    ...
    keymap = {
      manager.prepend_keymap = [
        ...
        { run = "cd ~/projects/github"; on = [ "g" "g" ]; desc = "Cd to ~/projects/github"; }
        { run = "cd ~/projects/github/abhi-xyz.github.io"; on = [ "g" "a" ]; desc = "Cd to ~/projects/github/abhi-xyz.github.io"; }
        { run = "cd ~/projects/rust"; on = [ "g" "p" "r" ]; desc = "Cd to ~/projects/rust"; }
      ];
    };
    #   input.keymap = [
    #     { exec = "close"; on = [ "<c-q>" ]; }
    ...
    theme = {
      ...
      filetype = {
        rules = [
          # Media
          { fg = "${catppuccin.sky}"; mime = "image/*"; }
          { fg = "${catppuccin.green}"; mime = "video/*"; }
          { fg = "${catppuccin.mauve}"; mime = "audio/*"; }
          { fg = "${catppuccin.blue}"; mime = "application/x-bzip"; } # from mynixos.com
          { fg = "${catppuccin.blue}"; mime = "application/x-{tar,bzip*,7z-compressed,xz,rar}"; }
